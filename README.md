...
[![Version](https://img.shields.io/badge/version-v6.63.0-blue.svg)](./CHANGELOG.md)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](./LICENSE)
[![AI Endpoints](https://img.shields.io/badge/AI%20endpoints-168+-green.svg)](./AI_ENDPOINTS.md)
...
> **168+ AI endpointov** za iskanje, ocenjevanje, kupovanje in preprodajo.
...
### Verzija v6.63.0 (28. julij 2026)

**168 AI endpointov** organiziranih v 7 kategorij:
...
### Kaj je novega v v6.63

- **AI Listing Description Generator v3** — 10 stilov, 5 variantov z ML scoring, persona personalization
- **AI Inventory Turnover Predictor** — 5 ML modelov za napoved obrtnosti z capital efficiency
- **AI Buyer Churn Prevention Strategist** — 10 strategij, 5 ML modelov, 30-dnevni intervention plan

▶️ Glej [CHANGELOG.md](./CHANGELOG.md) za popolno zgodovino v1.0 → v6.63.
...
Popolna zgodovina verzij v [CHANGELOG.md](./CHANGELOG.md) — od v1.0 (25. junij 2026) do v6.63 (28. julij 2026).
...
- **v6.61.0** (28. jul 2026) — Buyer Lifecycle Predictor, Listing Conversion Optimizer, Inventory Cash Flow Optimizer
- **v6.60.0** (28. jul 2026) — Buyer Sentiment Analyzer v2, Listing SEO Optimizer v2, Inventory Profitability Analyzer
