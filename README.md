...
[![Version](https://img.shields.io/badge/version-v6.86.0-blue.svg)](./CHANGELOG.md)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](./LICENSE)
[![AI Endpoints](https://img.shields.io/badge/AI%20endpoints-236+-green.svg)](./AI_ENDPOINTS.md)
...
> **236+ AI endpointov** za iskanje, ocenjevanje, kupovanje in preprodajo.
...
### Verzija v6.86.0 (29. julij 2026)

**236 AI endpointov** organiziranih v 7 kategorij:
...
### Kaj je novega v v6.86

- **AI Listing Emotional Trigger** — 10 čustvenih sprožilcev z behavioral psychology, 10 psiholoških dejavnikov, 5 ML modelov
- **AI Inventory Purchase Timing** — 5 timing tierjev z market timing, 10 tržnih razmer, price forecasting, 5 ML modelov
- **AI Buyer Loyalty Predictor v2** — 6 nivojev loyalnosti z behavior prediction, 10 dejavnikov, 6 intervencijskih tipov, 5 ML modelov

▶️ Glej [CHANGELOG.md](./CHANGELOG.md) za popolno zgodovino v1.0 → v6.86.
...
Popolna zgodovina verzij v [CHANGELOG.md](./CHANGELOG.md) — od v1.0 (25. junij 2026) do v6.86 (29. julij 2026).

### Zadnje verzije
- **v6.86.0** (29. jul 2026) — Listing Emotional Trigger, Inventory Purchase Timing, Buyer Loyalty Predictor v2
- **v6.85.0** (29. jul 2026) — Listing Mobile Optimizer, Inventory Supplier Evaluator, Buyer Feedback Analyzer
- **v6.84.0** (29. jul 2026) — Listing Content Improver, Inventory Storage Optimizer, Buyer Journey Mapper v2
...
- **v6.79.0** (29. jul 2026) — Listing Question Optimizer, Inventory Shrinkage Detector, Buyer Payment Reliability
- **v6.78.0** (28. jul 2026) — Listing Thumbnail Optimizer, Inventory Portfolio Analyzer, Buyer Spend Pattern Analyzer
