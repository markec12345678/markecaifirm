...
[![Version](https://img.shields.io/badge/version-v7.89.0-blue.svg)](./CHANGELOG.md)
...
[![AI Endpoints](https://img.shields.io/badge/AI%20endpoints-331-green.svg)](./AI_ENDPOINTS.md)
[![API Routes](https://img.shields.io/badge/API%20routes-506-cyan.svg)](#)
...
> **331 AI endpointov** + **70 analytics** + **10 cron automatizacij** + **11 Telegram ukazov** za iskanje, ocenjevanje, kupovanje in preprodajo.
...
### Verzija v7.89.0 (avgust 2026)

**331 AI endpointov** + **70 analytics** + **10 cron automatizacij** + **11 Telegram ukazov** + **~192 funkcij** organiziranih v 7 kategorij:
...
### Kaj je novega v v7.56–v7.89 (34 verzij, 102 novih funkcij)
...
| 17 | **AI Hub** | `a` | Vsi 331 AI endpointov z iskalnikom in runner-jem |
...
▶️ **Glej [AI_ENDPOINTS.md](./AI_ENDPOINTS.md) za popoln seznam vseh 331 AI endpointov.**
...
### Endpointi (331 AI + 70 analytics + 10 cron + sistemski = 506)
...
- Vsi API route handlerji imajo try/catch z logger.error (506 routes)
...
Popolna zgodovina verzij v [CHANGELOG.md](./CHANGELOG.md) — od v1.0 (25. junij 2026) do v7.89 (avgust 2026). Starejše verzije (v1.0–v6.x) so arhivirane v [ARCHIVE.md](./ARCHIVE.md).
