...
[![Version](https://img.shields.io/badge/version-v7.65.0-blue.svg)](./CHANGELOG.md)
...
[![AI Endpoints](https://img.shields.io/badge/AI%20endpoints-292-green.svg)](./AI_ENDPOINTS.md)
[![API Routes](https://img.shields.io/badge/API%20routes-434-cyan.svg)](#)
...
> **292 AI endpointov** + **37 analytics** + **10 cron automatizacij** + **11 Telegram ukazov** za iskanje, ocenjevanje, kupovanje in preprodajo.
...
### Verzija v7.65.0 (avgust 2026)

**292 AI endpointov** + **37 analytics** + **10 cron automatizacij** + **11 Telegram ukazov** + **~120 funkcij** organiziranih v 7 kategorij:
...
| 17 | **AI Hub** | `a` | Vsi 292 AI endpointov z iskalnikom in runner-jem |
...
▶️ **Glej [AI_ENDPOINTS.md](./AI_ENDPOINTS.md) za popoln seznam vseh 292 AI endpointov.**
...
- Vsi API route handlerji imajo try/catch z logger.error (434 routes)
...
Popolna zgodovina verzij v [CHANGELOG.md](./CHANGELOG.md) — od v1.0 (25. junij 2026) do v7.65 (avgust 2026). Starejše verzije (v1.0–v6.x) so arhivirane v [ARCHIVE.md](./ARCHIVE.md).
