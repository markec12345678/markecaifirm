...
[![Version](https://img.shields.io/badge/version-v6.55.0-blue.svg)](./CHANGELOG.md)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](./LICENSE)
[![AI Endpoints](https://img.shields.io/badge/AI%20endpoints-144+-green.svg)](./AI_ENDPOINTS.md)
...
> **144+ AI endpointov** za iskanje, ocenjevanje, kupovanje in preprodajo.
...
### Verzija v6.55.0 (28. julij 2026)

**144 AI endpointov** organiziranih v 7 kategorij:
...
### Kaj je novega v v6.55

- **AI Inventory Liquidation Strategist** — 10 strategij liquidation z timing in channel optimization
- **AI Buyer Engagement Optimizer** — 5 tier-ov, 8 faktorjev, 10 personalization strategij, 8 kampanj
- **AI Listing Performance Forecaster v3** — 8-model ensemble z 4 scenariji in sensitivity analysis

▶️ Glej [CHANGELOG.md](./CHANGELOG.md) za popolno zgodovino v1.0 → v6.55.
...
Popolna zgodovina verzij v [CHANGELOG.md](./CHANGELOG.md) — od v1.0 (25. junij 2026) do v6.55 (28. julij 2026).
