...
[![Version](https://img.shields.io/badge/version-v7.87.0-blue.svg)](./CHANGELOG.md)
...
[![AI Endpoints](https://img.shields.io/badge/AI%20endpoints-328-green.svg)](./AI_ENDPOINTS.md)
[![API Routes](https://img.shields.io/badge/API%20routes-500-cyan.svg)](#)
...
> **328 AI endpointov** + **67 analytics** + **10 cron automatizacij** + **11 Telegram ukazov** za iskanje, ocenjevanje, kupovanje in preprodajo.
...
### Verzija v7.87.0 (avgust 2026)

**328 AI endpointov** + **67 analytics** + **10 cron automatizacij** + **11 Telegram ukazov** + **~186 funkcij** organiziranih v 7 kategorij:
...
### Kaj je novega v v7.56–v7.87 (32 verzij, 96 novih funkcij)
...
| 17 | **AI Hub** | `a` | Vsi 328 AI endpointov z iskalnikom in runner-jem |
...
▶️ **Glej [AI_ENDPOINTS.md](./AI_ENDPOINTS.md) za popoln seznam vseh 328 AI endpointov.**
...
### Endpointi (328 AI + 67 analytics + 10 cron + sistemski = 500)
...
- Vsi API route handlerji imajo try/catch z logger.error (500 routes)
...
- [x] **Testing:** Vitest (37 tests), structured logger, try/catch na vseh 500 API routes
- [x] **0 vulnerabilities**, 0 TS errors, 0 ESLint errors

### Naslednji koraki
- [ ] UI komponente za v7.50-v7.87 funkcije v dashboard
...
Popolna zgodovina verzij v [CHANGELOG.md](./CHANGELOG.md) — od v1.0 (25. junij 2026) do v7.87 (avgust 2026). Starejše verzije (v1.0–v6.x) so arhivirane v [ARCHIVE.md](./ARCHIVE.md).
