// v6.11: AI Cross-Border Arbitrage — AI primerja cene med slovenskimi in tujimi trgi
...
export async function POST(req: NextRequest) {
  try {
    ...
    const prompt = `Si ekspert za cross-border arbitražo pri preprodaji rabljenih dobrin v Evropi.
...
Odgovori LE z JSON:
{
  ...
  "opportunities": [
    ...
    logger.error("/api/ai/cross-border", "POST handler failed", e);
