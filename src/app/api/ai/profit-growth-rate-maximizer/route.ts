...
export async function GET(req: NextRequest) {
  return handleProfitGrowthRateMaximizer(req);
}
export async function POST(req: NextRequest) {
  return handleProfitGrowthRateMaximizer(req);
}

async function handleProfitGrowthRateMaximizer(req: NextRequest) {
  try {
    const rl = checkRateLimit(req, 'ai-profit-growth-rate-maximizer', 20);
