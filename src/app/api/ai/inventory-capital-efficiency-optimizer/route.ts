...
Odgovori LE z JSON:
{
  ...
  } catch (e: any) { logger.error("/api/ai/inventory-capital-efficiency-optimizer", "POST handler failed", e); return NextResponse.json({ error: e?.message ?? 'Napaka' }, { status: 500 }); }
}
