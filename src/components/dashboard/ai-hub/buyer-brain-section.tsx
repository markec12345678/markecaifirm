...
// v8.97: Buyer Brain section extracted from ai-hub-view.tsx (v8.20, cyan/teal).
// Self-contained — fetches /api/ai/brain/buyer on mount, renders top 3 cultivation
// actions + 30d/90d buyer projection (projectedActiveBuyers + LTV + churn).
