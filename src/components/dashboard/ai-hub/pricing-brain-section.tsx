...
// v8.97: Pricing Brain section extracted from ai-hub-view.tsx (v8.21, green/lime).
// Self-contained — fetches /api/ai/brain/pricing on mount, renders top 3 pricing
// actions + 30d/90d pricing projection (projectedMarginPct + projectedRevenue + recommendedPriceChangePct).
