...
// v8.97: System Health Card extracted from ai-hub-view.tsx (v8.32).
// Aggregates entire Brain system health: 8 brain endpoints grid + data freshness
// + auto-pilot status + draft queue + risk profile + adaptive weights + recommendations.
// Auto-refreshes every 60s. Fetches /api/ai/brain/health (30s cache).
// Local const BRAIN_HEALTH_ICONS co-located (icon metadata per brain).
...
import {
  Brain, AlertCircle, RefreshCw, HeartPulse, Coins, Package, TrendingUp,
  Target, Shield, Users, Crown, Camera, Bot, ClipboardList, Settings2, Info,
} from 'lucide-react';
...
export function SystemHealthCard({ onBrainCategoryClick }: SystemHealthCardProps) {
