...
// v8.97: Risk Brain section extracted from ai-hub-view.tsx (v8.19, red/rose).
// Self-contained — fetches /api/ai/brain/risk on mount, renders top 3 mitigation
// actions + 30d/90d risk projection (projectedRiskScore + recommendedRiskBudget).
