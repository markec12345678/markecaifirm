...
// v8.97: Master Brain Banner extracted from ai-hub-view.tsx (v8.22, gold/amber).
// FINAL orchestration layer — synthesizes 7 Domain Brain outputs into ONE decision.
// Fetches /api/ai/brain/master. Renders TOP 5 actions + strategy 30d/90d/12m pills +
// conflicts + bottlenecks/strengths. v8.26 adds per-action explanations (ℹ️ Zakaj?).
// v8.29 adds ✅/❌ buttons that PATCH /api/ai/brain/drafts/{id} + recordActionFeedback.
...
import {
  Crown, AlertCircle, RefreshCw, Info, Check, X, ChevronDown, ChevronUp,
} from 'lucide-react';
import { toast } from 'sonner';
import { cn } from '@/lib/utils';
import type { MasterBrainResult } from './types';
import {
  gradeColor, confidenceColor, riskLevelColor, conflictSeverityColor,
  trustScoreColor, signalGradeColor, DOMAIN_LABELS,
} from './utils';
