...
// v8.97: Performance & Cache Stats Card extracted from ai-hub-view.tsx (v8.33).
// Shows per-namespace cache hit/miss/sets + per-brain response times (avg/p50/p95/p99/min/max)
// + overall summary (4 big numbers) + reset button. Auto-refresh every 30s.

import { useEffect, useState, useCallback } from 'react';
import { Badge } from '@/components/ui/badge';
import { Button } from '@/components/ui/button';
import { Skeleton } from '@/components/ui/skeleton';
import { Zap, AlertCircle, RefreshCw, Trash2, Brain, Activity } from 'lucide-react';
import { toast } from 'sonner';
import { cn } from '@/lib/utils';
import type { PerformanceReport } from './types';
import {
  hitRateColor, responseTimeColor, hitRateBarColor, namespaceLabel,
} from './utils';
...
export function PerformanceCard({ onBrainCategoryClick }: PerformanceCardProps) {
