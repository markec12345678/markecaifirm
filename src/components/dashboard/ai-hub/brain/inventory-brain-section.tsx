/**
 * Inventory Brain Section (v8.16, amber) — 6 inventory signals.
 *
 * Extracted from the original `brain-sections.tsx` (1147 lines) as part of
 * v8.94.8-split-brain. Fetches `/api/ai/brain/inventory`, displays
 * `oneLineSummary` + inventory grade pill + top 3 actions + 30d/90d
 * STRUCTURED projections (recommendedItemsToSell/Buy + projectedInventoryValue
 * + projectedTurnoverRate), and provides a refresh button.
 *
 * Projection shape: structured objects (different from Profit's scalars).
 */
