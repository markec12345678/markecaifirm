/**
 * Market Brain Section (v8.17, sky/blue) — 6 market signals.
 *
 * Extracted from the original `brain-sections.tsx` (1147 lines) as part of
 * v8.94.8-split-brain. Fetches `/api/ai/brain/market`, displays
 * `oneLineSummary` + market grade pill + top 3 actions + current cycle phase +
 * 30d/90d STRUCTURED projections (predictedPhase + predictedPriceChangePct +
 * recommendedAction BUY/SELL/HOLD/LIQUIDATE), and provides a refresh button.
 *
 * Projection shape: structured objects with phase + price-change pct +
 * recommended action (different from both Profit scalars and Inventory
 * recommendedItemsToSell/Buy shapes).
 */
