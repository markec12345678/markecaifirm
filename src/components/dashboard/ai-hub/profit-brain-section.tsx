...
// v8.97: Profit Brain section extracted from ai-hub-view.tsx (v8.15, emerald).
// Self-contained — fetches /api/ai/brain/profit on mount, renders top 3 actions
// + 30d/90d profit projection. No props.
