/**
 * AccuracyTrendCard — historical accuracy meta-analysis (v8.25, teal).
 *
 * Extracted from the original `snapshots-accuracy.tsx` (577 lines) as part of
 * v8.94.9-split. Two big-number accuracy pills (30d, 90d) + OverallHealth
 * sparkline + 7-domain grade trend table.
 *
 *   - GET  /api/ai/brain/accuracy?days=30      → accuracy + gradeTrend[]
 *   - POST /api/ai/brain/accuracy/backfill     → manual backfill trigger
 *
 ...
 * Color helpers come from ../../utils (gradeColor, gradeTrendPill,
 * trendBadgeClass, trendIcon).
 */
