/**
 * ActualProfitCard — v8.23 indigo/violet GROUND TRUTH profit card.
 *
 * Extracted from the original `system-cards.tsx` (1947 lines) as part of
 * v8.94.7-split. Shows GROUND TRUTH: actual EUR profit computed from the
 * Trade table (status='sold', sellDate within last N days). Placed ABOVE
 * the Master Brain banner because ground truth should be the first thing
 * the user sees, before predictions.
 *
