...
// v8.97: Risk Profile Card extracted from ai-hub-view.tsx (v8.24).
// Makes Master Brain PERSONAL: 4 user-configurable fields (riskTolerance,
// maxAcceptableRisk, liquidityReserve, investmentHorizon) stored in Settings.
// Local consts RISK_TOLERANCE_OPTIONS + INVESTMENT_HORIZON_OPTIONS co-located.
...
import { Settings2, AlertCircle, RefreshCw, Save } from 'lucide-react';
import { toast } from 'sonner';
import { cn } from '@/lib/utils';
import type {
  RiskTolerance, InvestmentHorizon, UserRiskProfile,
  RiskProfileAdjustment, RiskProfileApiResponse,
} from './types';
