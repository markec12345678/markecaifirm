...
import { RefreshCw, BarChart3, TrendingUp, TrendingDown, Target, AlertCircle, Activity, ThumbsUp, ThumbsDown, Archive, Bell, Wallet } from 'lucide-react';
...
import { ArbitrageOpportunities } from './analytics/arbitrage-opportunities';
import { CrossPortalArbitrage } from './analytics/cross-portal-arbitrage';
import { AiTrendPredictions } from './analytics/ai-trend-predictions';
import { CompetitorSellers } from './analytics/competitor-sellers';
    ...
    <div className="space-y-4">
      ...
      {!hasData ? (
        ...
        <>
          ...
          {/* v6.5: Seasonal Trend Calendar */}
          <SeasonalCalendar />

          {/* v6.6: Price War Detection */}
          <PriceWarDetection />
