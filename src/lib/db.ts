...
console.log('[db.ts] module loaded at', new Date().toISOString(), 'schemaVersion=v8.31-aggressive-anomaly');
...
const SCHEMA_VERSION = 'v8.31-aggressive-anomaly' // bumped for v8.31 aggressive + anomaly fields on Settings
