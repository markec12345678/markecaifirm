#!/usr/bin/env python3
"""Update AI_ENDPOINTS.md with 3 new v6.87 endpoints, renumber all rows sequentially."""
import re
...
NEW_ENDPOINTS = [
    ("buyer-clv-predictor", "/api/ai/buyer-clv-predictor"),
    ("inventory-cost-forecast", "/api/ai/inventory-cost-forecast"),
    ("listing-audience-targeting", "/api/ai/listing-audience-targeting"),
]
