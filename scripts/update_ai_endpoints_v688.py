#!/usr/bin/env python3
"""Update AI_ENDPOINTS.md with 3 new v6.88 endpoints, renumber all rows sequentially."""
import re
...
NEW_ENDPOINTS = [
    ("buyer-referral-predictor", "/api/ai/buyer-referral-predictor"),
    ("inventory-liquidation-optimizer", "/api/ai/inventory-liquidation-optimizer"),
    ("listing-visual-hierarchy", "/api/ai/listing-visual-hierarchy"),
]
