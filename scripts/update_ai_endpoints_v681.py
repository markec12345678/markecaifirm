#!/usr/bin/env python3
"""Update AI_ENDPOINTS.md with 3 new v6.81 endpoints, renumber all rows sequentially."""
import re
...
NEW_ENDPOINTS = [
    ("buyer-churn-predictor-v2", "/api/ai/buyer-churn-predictor-v2"),
    ("inventory-demand-forecaster", "/api/ai/inventory-demand-forecaster"),
    ("listing-cross-sell-optimizer", "/api/ai/listing-cross-sell-optimizer"),
]
