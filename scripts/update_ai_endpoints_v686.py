#!/usr/bin/env python3
"""Update AI_ENDPOINTS.md with 3 new v6.86 endpoints, renumber all rows sequentially."""
import re
...
NEW_ENDPOINTS = [
    ("buyer-loyalty-predictor-v2", "/api/ai/buyer-loyalty-predictor-v2"),
    ("inventory-purchase-timing", "/api/ai/inventory-purchase-timing"),
    ("listing-emotional-trigger", "/api/ai/listing-emotional-trigger"),
]
