#!/usr/bin/env python3
"""Update AI_ENDPOINTS.md with 3 new v6.89 endpoints, renumber all rows sequentially."""
import re
...
NEW_ENDPOINTS = [
    ("buyer-engagement-predictor-v2", "/api/ai/buyer-engagement-predictor-v2"),
    ("inventory-aging-strategist", "/api/ai/inventory-aging-strategist"),
    ("listing-color-psychology", "/api/ai/listing-color-psychology"),
]
