#!/usr/bin/env python3
"""Update AI_ENDPOINTS.md with 3 new v6.91 endpoints, renumber all rows sequentially."""
import re
...
NEW_ENDPOINTS = [
    ("buyer-reactivation-engine", "/api/ai/buyer-reactivation-engine"),
    ("inventory-carrying-cost", "/api/ai/inventory-carrying-cost"),
    ("listing-image-quality-scorer", "/api/ai/listing-image-quality-scorer"),
]
