#!/usr/bin/env python3
"""Update AI_ENDPOINTS.md with 3 new v6.92 endpoints, renumber all rows sequentially."""
import re
...
NEW_ENDPOINTS = [
    ("buyer-social-influence-scorer", "/api/ai/buyer-social-influence-scorer"),
    ("inventory-damage-prevention", "/api/ai/inventory-damage-prevention"),
    ("listing-image-background-cleaner", "/api/ai/listing-image-background-cleaner"),
]
