#!/usr/bin/env python3
"""Update AI_ENDPOINTS.md with 3 new v6.84 endpoints, renumber all rows sequentially."""
import re
...
NEW_ENDPOINTS = [
    ("buyer-journey-mapper-v2", "/api/ai/buyer-journey-mapper-v2"),
    ("inventory-storage-optimizer", "/api/ai/inventory-storage-optimizer"),
    ("listing-content-improver", "/api/ai/listing-content-improver"),
]
