#!/usr/bin/env python3
"""Update AI_ENDPOINTS.md with 3 new v6.90 endpoints, renumber all rows sequentially."""
import re
...
NEW_ENDPOINTS = [
    ("buyer-trust-builder", "/api/ai/buyer-trust-builder"),
    ("inventory-procurement-optimizer", "/api/ai/inventory-procurement-optimizer"),
    ("listing-typography-optimizer", "/api/ai/listing-typography-optimizer"),
]
