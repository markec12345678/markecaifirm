#!/usr/bin/env python3
"""Update AI_ENDPOINTS.md with 3 new v6.85 endpoints, renumber all rows sequentially."""
import re
...
NEW_ENDPOINTS = [
    ("buyer-feedback-analyzer", "/api/ai/buyer-feedback-analyzer"),
    ("inventory-supplier-evaluator", "/api/ai/inventory-supplier-evaluator"),
    ("listing-mobile-optimizer", "/api/ai/listing-mobile-optimizer"),
]
