#!/usr/bin/env python3
"""Update AI_ENDPOINTS.md with 3 new v6.83 endpoints, renumber all rows sequentially."""
import re
...
NEW_ENDPOINTS = [
    ("buyer-persona-enricher", "/api/ai/buyer-persona-enricher"),
    ("inventory-reorder-point", "/api/ai/inventory-reorder-point"),
    ("listing-trend-detector", "/api/ai/listing-trend-detector"),
]
